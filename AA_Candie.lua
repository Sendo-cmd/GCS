...
getgenv().Config = {
	...
	["Auto Play"] = {
		...
		["Middle Position"] = {
			...
			["Navy Bay (Haunted)"] = "-2587.32421875, 25.210872650146484, -70.11207580566406",
			["Sand Village (Haunted)"] = "-865.1871948242188, 25.065471649169922, 268.7599182128906",
			["Snowy Town (Haunted)"] = "-2880.7568359375, 34.34697723388672, -130.48460388183594",
		}
	},
	["Failsafe"] = {
		["Auto Rejoin"] = true,
