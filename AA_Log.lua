...
if game.PlaceId == 8304191830  then
    ...
    local response = request({
        ...
        ["Body"] = HttpService:JSONEncode({
            ...
            ["Place"] = "Lobby",
            ["Username"] = plr.Name,
            ["inventory"] = game:GetService("HttpService"):JSONEncode(session["inventory"]["inventory_profile_data"]),
    ...
    game:GetService("ReplicatedStorage").endpoints.server_to_client.game_finished.OnClientEvent:Connect(function(g)
        ...
        local response = request({
            ...
            ["Body"] = HttpService:JSONEncode({
                ...
                ["MapInfo"] = game:GetService("HttpService"):JSONEncode(workspace._MAP_CONFIG.GetLevelData:InvokeServer()),
                ["GuildId"] = "467359347744309248",
                ["DataKey"] = "GamingChampionShopAPI",
            })
        })
