getgenv().Config = {
	...
	["Stat Reroller"] = {
		...
		["Stat"] = {
			["S"] = false,
			["ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¥ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¾"] = false,
			["Z+"] = false,
			["ÃƒÂ§Ã‚Â¥Ã…Â¾"] = false,
			["Z"] = false,
			["ç¥ž"] = false,
			["Ã§Â¥Å¾"] = false,
			["ÃƒÆ’Ã‚Â§Ãƒâ€šÃ‚Â¥Ãƒâ€¦Ã‚Â¾"] = false,
			["ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â§ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¥ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¾"] = false
		}
	},
	["Trait Reroller"] = {
		["Enable"] = false
